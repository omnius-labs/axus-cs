...
namespace Xeus.Engine
{
    sealed class CoreManager : StateManagerBase, ISettings
    {
        ...
        public CoreManager(string configPath, string blocksPath, BufferPool bufferPool)
        {
            _bufferPool = bufferPool;
            _cacheManager = new CacheManager(Path.Combine(configPath, "Cache"), blocksPath, _bufferPool);
            _networkManager = new ExchangeManager(Path.Combine(configPath, "Network"), _cacheManager, _bufferPool);
            _downloadManager = new DownloadManager(Path.Combine(configPath, "Download"), _networkManager, _cacheManager, _bufferPool);
