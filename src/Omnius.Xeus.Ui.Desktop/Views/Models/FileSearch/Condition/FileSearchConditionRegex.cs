...
{
    class FileSearchConditionRegex : IFileSearchCondition<string>, IEquatable<FileSearchConditionRegex>
    {
        ...
        {
            return this.Equals(obj as FileSearchConditionRegex);
        }

        public bool Equals(FileSearchConditionRegex? other)
        {
            if (other is null)
            {
                return false;
