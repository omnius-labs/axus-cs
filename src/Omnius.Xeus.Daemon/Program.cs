    ...
    public class Program : CoconaLiteConsoleAppBase
    {
        ...
        public async ValueTask RunAsync([Option('c')] string configDirectoryPath = "../config")
        {
            ...
            var options = new XeusServiceOptions
            {
                ...
                PushContentStorageFactory = ContentPublisher.Factory,
                WantContentStorageFactory = ContentSubscriber.Factory,
                PushDeclaredMessageStorageFactory = DeclaredMessagePublisher.Factory,
                WantDeclaredMessageStorageFactory = DeclaredMessageSubscriber.Factory,
