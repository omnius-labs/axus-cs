...
public sealed partial class BarkSubscriber : AsyncDisposableBase, IBarkSubscriber
{
    ...
    private const string Registrant = "Omnius.Axis.Interactors.BarkSubscriber";

    public static async ValueTask<BarkSubscriber> CreateAsync(IAxisServiceMediator service, ISingleValueStorageFactory singleValueStorageFactory, IKeyValueStorageFactory keyValueStorageFactory, IBytesPool bytesPool, BarkSubscriberOptions options, CancellationToken cancellationToken = default)
    {
    ...
    private BarkSubscriber(IAxisServiceMediator service, ISingleValueStorageFactory singleValueStorageFactory, IKeyValueStorageFactory keyValueStorageFactory, IBytesPool bytesPool, BarkSubscriberOptions options)
    {
