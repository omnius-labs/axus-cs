...
public interface IAxusServiceMediator
{
    ...
    ValueTask<OmniHash> PublishFileFromMemoryAsync(ReadOnlyMemory<byte> memory, int maxBlockSize, string zone, CancellationToken cancellationToken = default);
    ValueTask<OmniHash> PublishFileFromStorageAsync(string filePath, int maxBlockSize, string zone, CancellationToken cancellationToken = default);
    ValueTask PublishShoutAsync(Shout message, string zone, CancellationToken cancellationToken = default);
