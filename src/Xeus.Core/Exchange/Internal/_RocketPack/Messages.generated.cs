...
namespace Xeus.Core.Exchange.Internal
{
    ...
    internal sealed partial class BroadcastClue : Omnix.Serialization.RocketPack.RocketPackMessageBase<BroadcastClue>
    {
        static BroadcastClue()
        {
            ...
            BroadcastClue.Empty = new BroadcastClue(string.Empty, Omnix.Serialization.RocketPack.Timestamp.Zero, XeusClue.Empty, OmniCertificate.Empty);
        }
        ...
        public BroadcastClue(string type, Omnix.Serialization.RocketPack.Timestamp creationTime, XeusClue clue, OmniCertificate certificate)
        {
    ...
    internal sealed partial class UnicastClue : Omnix.Serialization.RocketPack.RocketPackMessageBase<UnicastClue>
    {
        static UnicastClue()
        {
            ...
            UnicastClue.Empty = new UnicastClue(string.Empty, OmniSignature.Empty, Omnix.Serialization.RocketPack.Timestamp.Zero, XeusClue.Empty, OmniCertificate.Empty);
        }
        ...
        public UnicastClue(string type, OmniSignature signature, Omnix.Serialization.RocketPack.Timestamp creationTime, XeusClue clue, OmniCertificate certificate)
        {
            if (type is null) throw new System.ArgumentNullException("type");
            if (type.Length > 256) throw new System.ArgumentOutOfRangeException("type");
