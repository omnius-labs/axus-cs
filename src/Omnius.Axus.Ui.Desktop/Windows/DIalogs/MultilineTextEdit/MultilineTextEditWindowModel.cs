...
public abstract class MultilineTextEditWindowModelBase : AsyncDisposableBase
{
...
public class MultilineTextEditWindowModel : MultilineTextEditWindowModelBase
{
    ...
    public MultilineTextEditWindowModel(UiStatus uiState, IClipboardService clipboardService)
    {
        _uiState = uiState;
