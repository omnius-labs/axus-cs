...
namespace Xeus.Engine.Negotiators.Internal
{
    ...
    internal sealed partial class WantBlocksMessage : global::Omnius.Core.Serialization.OmniPack.IOmniPackMessage<WantBlocksMessage>
    {
        public static global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<WantBlocksMessage> Formatter { get; }
        ...
        public WantBlocksMessage(OmniHash[] parameters)
        {
            ...
            this.Parameters = new global::Omnius.Core.ReadOnlyListSlim<OmniHash>(parameters);
        ...
        public global::Omnius.Core.ReadOnlyListSlim<OmniHash> Parameters { get; }

        public static WantBlocksMessage Import(global::System.Buffers.ReadOnlySequence<byte> sequence, global::Omnius.Core.IBufferPool<byte> bufferPool)
        {
            var reader = new global::Omnius.Core.Serialization.OmniPack.OmniPackReader(sequence, bufferPool);
            return Formatter.Deserialize(ref reader, 0);
        }
        ...
        private sealed class ___CustomFormatter : global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<WantBlocksMessage>
        {
            public void Serialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackWriter w, in WantBlocksMessage value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public WantBlocksMessage Deserialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
    ...
    internal sealed partial class CancelBlocksMessage : global::Omnius.Core.Serialization.OmniPack.IOmniPackMessage<CancelBlocksMessage>
    {
        public static global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<CancelBlocksMessage> Formatter { get; }
        ...
        public static CancelBlocksMessage Import(global::System.Buffers.ReadOnlySequence<byte> sequence, global::Omnius.Core.IBufferPool<byte> bufferPool)
        {
            var reader = new global::Omnius.Core.Serialization.OmniPack.OmniPackReader(sequence, bufferPool);
            return Formatter.Deserialize(ref reader, 0);
        }
        ...
        private sealed class ___CustomFormatter : global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<CancelBlocksMessage>
        {
            public void Serialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackWriter w, in CancelBlocksMessage value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public CancelBlocksMessage Deserialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
    ...
    internal sealed partial class BlocksMessages : global::Omnius.Core.Serialization.OmniPack.IOmniPackMessage<BlocksMessages>
    {
        public static global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<BlocksMessages> Formatter { get; }
        ...
        public BlocksMessages(OmniHashAlgorithmType hashAlgorithm, global::System.Buffers.IMemoryOwner<byte>[] blocks)
        {
            ...
            this.Blocks = new global::Omnius.Core.ReadOnlyListSlim<global::System.Buffers.IMemoryOwner<byte>>(blocks);
            ...
            ___hashCode = new global::System.Lazy<int>(() =>
            {
                ...
                foreach (var n in blocks)
                {
                    if (!n.Memory.IsEmpty) ___h.Add(global::Omnius.Core.Helpers.ObjectHelper.GetHashCode(n.Memory.Span));
                }
                return ___h.ToHashCode();
            });
        }
        ...
        public global::Omnius.Core.ReadOnlyListSlim<global::System.Buffers.IMemoryOwner<byte>> Blocks { get; }

        public static BlocksMessages Import(global::System.Buffers.ReadOnlySequence<byte> sequence, global::Omnius.Core.IBufferPool<byte> bufferPool)
        {
            var reader = new global::Omnius.Core.Serialization.OmniPack.OmniPackReader(sequence, bufferPool);
            return Formatter.Deserialize(ref reader, 0);
        }
        ...
        public bool Equals(BlocksMessages? target)
        {
            ...
            if (!global::Omnius.Core.Helpers.CollectionHelper.Equals(this.Blocks, target.Blocks)) return false;

            return true;
        }
        public override int GetHashCode() => ___hashCode.Value;

        private sealed class ___CustomFormatter : global::Omnius.Core.Serialization.OmniPack.IOmniPackFormatter<BlocksMessages>
        {
            public void Serialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackWriter w, in BlocksMessages value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public BlocksMessages Deserialize(ref global::Omnius.Core.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
