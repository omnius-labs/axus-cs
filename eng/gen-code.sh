...
"$TOOL_PATH" $PWD/fmt/Omnius.Xeus.Service.Implements/Omnius.Xeus.Service.Internal.rpd $INCLUDE -o $PWD/src/Omnius.Xeus.Service.Implements/Internal/_RocketPack/Messages.generated.cs
