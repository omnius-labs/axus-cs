...
"$TOOL_PATH" -f "$PWD/fmt/Omnius.Xeus.Service.Implements/Omnius.Xeus.Service.Drivers.Internal.rpd" -i "$INCLUDE_1" "$INCLUDE_2" -o "$PWD/src/Omnius.Xeus.Service.Implements/Drivers/Internal/_RocketPack/Messages.generated.cs"
"$TOOL_PATH" -f "$PWD/fmt/Omnius.Xeus.Service.Implements/Omnius.Xeus.Service.Engines.Internal.rpd" -i "$INCLUDE_1" "$INCLUDE_2" -o "$PWD/src/Omnius.Xeus.Service.Implements/Engines/Internal/_RocketPack/Messages.generated.cs"
