...
"$TOOL_PATH" -f "$PWD/fmt/Omnius.Xeus.Service.Impls/Omnius.Xeus.Service.Storages.Internal.rpd" -i "$INCLUDE_1" "$INCLUDE_2" -o "$PWD/src/Omnius.Xeus.Service.Impls/Storages/Internal/_RocketPack/Messages.generated.cs"
